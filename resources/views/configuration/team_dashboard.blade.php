            ...
            <div class="card card-dark card-tabs">
                <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs" id="teamInformation" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="teamPlayerList-tab" data-toggle="pill" href="#teamPlayerList"
                               role="tab" aria-controls="teamPlayerList" aria-selected="true">Lista de Jogadores</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="teamMatchesList-tab" data-toggle="pill" href="#teamMatchesList"
                               role="tab" aria-controls="teamMatchesList" aria-selected="false">Últimas Partidas</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content" id="teamInformationContent">
                        <div class="tab-pane active" id="teamPlayerList" role="tabpanel"
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        @if($teamPlayer->profile_picture)
                                                            <img
                                                                src="{{ asset('storage/' . $teamPlayer->profile_picture) }}"
                                                                class="card-img-top">
                                                        @else
                                                            <img src="{{ asset('img/no-profile-photo.png') }}"
                                                                 class="card-img-top">
                                                        @endif
                                                        <div class="col-6">
                                                            <h3> Posição </h3>
                                                        ...
                                                        <div class="col-12">
                                                            <h3> Nome </h3>
                                                            <p> {{ $teamPlayer->name }} </p> @if($teamPlayer->nickname)
                                                                <p class='text-muted'> ({{ $teamPlayer->nickname}}) </p>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="tab-pane fade" id="teamMatchesList" role="tabpanel"
                             aria-labelledby="teamMatchesList-tab">
                            ...
                            @else
                                <div class="alert alert-danger"> Nenhum jogo cadastrado, <a
                                        href="{{ route('matches.create', $team->id) }}"> clique aqui para cadastrar
                                        um </a></div>
                            @endif
                        </div>
                    </div>
